...
const FAQS = [
  {
    ...
    a: "نعم، نبدأ في كل المسارات من الصفر المطلق ونقوم بتأسيس المفاهيم الأساسية وتفكيك القوانين الرياضية خطوة بخطوة.[cite: 21]",
  },
  {
    q: "ما هو الفرق بين البث المباشر والدورات المسجلة؟",
    a: "البث المباشر يتيح لكِ التفاعل والتوجيه اللحظي المباشر وطرح الأسئلة مع الأستاذة ريناد، بينما المسجلة توفر لكِ حرية المشاهدة بأي وقت ووصول كامل مدى الحياة.[cite: 21]",
  },
  {
    q: "كيف أحصل على ملفات التجميعات والتسريبات؟",
    a: "فور إتمام حجز مقعدكِ وتأكيد الحساب، سيتم إرسال كافة الحقائب الرقمية وملفات الـ PDF مباشرة وتلقائياً عبر الواتساب ومجتمعاتنا.[cite: 21]",
  },
];
